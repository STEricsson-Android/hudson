...
rm -f .repo/local_manifests/dyn-*.xml
repo init -u $SYNC_PROTO://github.com/STEricsson-Android/android.git -b $CORE_BRANCH $MANIFEST
...
git clone https://github.com//cm_build_config.git $WORKSPACE/build_env
